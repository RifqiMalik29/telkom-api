...
module.exports = {
    getAllProductAsc: (name) => query(`SELECT * FROM product WHERE product_name LIKE '%${name}%' ORDER BY price ASC`),
    getAllProductDesc: (name) => query(`SELECT * FROM product WHERE product_name LIKE '%${name}%' ORDER BY price DESC`),
